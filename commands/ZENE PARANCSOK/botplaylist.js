...
module.exports = {
  ...
  useage: "playlist <Lista szám>",
  description: "Játssz néhány előre elkészített JÓ lejátszási listát!",
  ...
  run: async (client, message, args) => {
    ...
    if (args[0]) {
      switch (args[0].toLowerCase()) {
        case "1":
          functions.embedbuilder(client, "null", message, config.colors.yes, "Betöltés");
        ...
        default:
          functions.embedbuilder(client, "null", message, config.colors.no, `Elérhető Lista:`, "1. Charts\n2. Christmas\n3. Jazz\n4. Blues\n5. Country\n6. Rock")
          return functions.embedbuilder(client, "null", message, config.colors.no, `Parancs használata:`, "+botplaylist <Lista szám>")
          break;
      }
    } else {
      functions.embedbuilder(client, "null", message, config.colors.no, `Elérhető Lista:`, "1. Charts\n2. Christmas\n3. Jazz\n4. Blues\n5. Country\n6. Rock")
