...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        //return functions.embedbuilder(client, 6000, message, config.colors.no, "DJ-Rang", `❌ You don\'t have permission for this Command! You need to have: ${functions.check_if_dj(message)}`)
        ...
        if (client.distube.isPaused(message)) return functions.embedbuilder(client, "null", message, config.colors.no, "Sikeresen megállítva")

        //send information message
        functions.embedbuilder(client, 3000, message, config.colors.yes, "Megállítva!")
