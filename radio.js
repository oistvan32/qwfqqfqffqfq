  ...
  module.exports = async function (client, message, args) {
      ...
      if (!channel) return message.reply("Kérlek lépj be egy hangcsatornába!")
      ...
      if (isNaN(args[0])) {
          return message.reply(
              ...
              .setTitle(`Kérelek adj megy egy számot: \`1\` és \`${Radiostations.length}\` között`)
          );
      }
      if (Number(args[1]) > 150) return message.reply("**Maximum hang:`150`!**")
      if (Number(args[1]) < 1) return message.reply("**Minimum hang: `1`!**")
      let volume;
      if (isNaN(args[1])) {
          volume = 50;
      } else {
      ...
      if (Number([args[0]]) > 0 && Number(args[0]) <= 10)
          ...
          return message.reply("Ez a frekvencia nem található!")
      ...
      if (message.guild.me.connection && channel !== message.guild.me.voice.channel)
          return message.reply(`Ugyanabban a Hangcsatornában van, mint én`);
  ...
  function stations(client, prefix, message) {
      ...
      const infoembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("130 Radió frekvencia", client.user.displayAvatarURL(), " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(`
        \`\`\`Használd ezeket a rádióállomásokat minden országban:\`\`\`
        ...
        **Page 18:** \`Ukraine\`
        ...
        __**EGYEDI KÉRÉSEK**__
        **Page 19:** \`First 10 custom Requests\`
    
        Ha rádióállomást szeretne hallgatni, egyszerűen írja be: **\`${prefix}play <Állomás száma a név előtt > [HANG]\`** de a hangerő 1 és 150 közötti szám kell legyen!
        Például: **\`${prefix}play 12 50\`**  -- Ez játssza a rádióállomást: ** 50-es hanggal**!
        `)

      const United_Kingdomembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("United_Kingdom - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-united-kingdom_1f1ec-1f1e7.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(United_Kingdom)
      const austriaembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Austria - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-austria_1f1e6-1f1f9.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(austria)
      const Belgiumembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Belgium - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-belgium_1f1e7-1f1ea.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Belgium)
      const Bosniaembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Bosnia & Herzegovina - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-bosnia-herzegovina_1f1e7-1f1e6.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Bosnia)
      const Czechembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Czech - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-czechia_1f1e8-1f1ff.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Czech)
      const Denmarkembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Denmark - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-denmark_1f1e9-1f1f0.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Denmark)
      const germanyembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Germany - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-germany_1f1e9-1f1ea.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(germany)
      const Hungaryembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Hungary - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-hungary_1f1ed-1f1fa.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Hungary)
      const Irelandembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Ireland - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-ireland_1f1ee-1f1ea.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Ireland)
      const Italyembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Italy - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-italy_1f1ee-1f1f9.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Italy)
      const Luxembourgembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Luxembourg - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-luxembourg_1f1f1-1f1fa.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Luxembourg)
      const Romaniaembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Romania - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-romania_1f1f7-1f1f4.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Romania)
      const Serbiaembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Serbia - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-serbia_1f1f7-1f1f8.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Serbia)
      const Spainembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Romania - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-spain_1f1ea-1f1f8.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Spain)
      const Swedenembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Sweden - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-sweden_1f1f8-1f1ea.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Sweden)
      const TURKEYembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Turkey - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-turkey_1f1f9-1f1f7.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(TURKEY)
      const Ukraineembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Ukraine - Rádió állomások", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-ukraine_1f1fa-1f1e6.png", " https://milrato.eu")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Ukraine)

      const Reqeustembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Kért - Rádió állomások", client.user.displayAvatarURL())
          .setFooter(client.user.username, client.user.displayAvatarURL())
