...
module.exports = {
  ...
  useage: "status",
  aliases: ["settings"],
  description: "Megjeleníti listát a statisztikát és a beállításait",
  run: async (client, message, args) => {
    ...
    if (!queue) return functions.embedbuilder(client, "null", message, config.colors.no, "Nincs hallható zene");
